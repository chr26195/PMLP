...
def evaluate(model, dataset, split_idx, eval_func, criterion, args, result=None):
    ...
    if result is not None:
        ...
        out_tr = model(dataset.graph['node_feat'], dataset.graph['edge_index' if args.trans else 'tr_edge_index'])
    out = model(dataset.graph['node_feat'], dataset.graph['edge_index'])
    out_va = model(dataset.graph['node_feat'], dataset.graph['edge_index' if args.trans else 'va_edge_index'])
    # ------------------------------------------------------------------------------------- 
